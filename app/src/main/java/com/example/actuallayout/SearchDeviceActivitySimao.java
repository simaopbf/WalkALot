...
import com.example.actuallayout.AcquisitionServiceSimao;
import com.example.actuallayout.R;
import com.example.actuallayout.ResultsActivitySimao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonOK.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                Intent serviceIntent = new Intent(getApplicationContext(), AcquisitionServiceSimao.class);
